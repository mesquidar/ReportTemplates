...
[void]$html.AppendLine('    <meta name="description" content="Cervantes Bastion Directory identity security report"/>')
[void]$html.AppendLine('    <title>{{ProjectName}} | Bastion Directory Report</title>')
[void]$html.AppendLine('</head>')

...
[void]$html.AppendLine('    <meta name="description" content="Cervantes Atlas Foundation general assessment and learning report"/>')
[void]$html.AppendLine('    <title>{{ProjectName}} — Atlas Foundation Report</title>')
[void]$html.AppendLine('</head>')
